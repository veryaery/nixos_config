...
pub fn build_cli() -> Command<'static> {
    ...
    Command::new(crate_name!())
        ...
        .subcommand(
            Command::new("maxcontrast")
                .about("Returns the color option with the maximum contrast with color.")
                .arg(
                    Arg::new("color")
                        .help("Use '-' to read the color from STDIN.")
                        .required(true),
                )
                .arg(
                    Arg::new("option")
                        .help("Color options. Use '-' to read the color from STDIN.")
                        .required(true)
                        .multiple_occurrences(true),
                ),
        )
